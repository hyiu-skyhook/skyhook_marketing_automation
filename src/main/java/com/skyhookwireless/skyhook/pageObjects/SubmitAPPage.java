 ...
 *
 */
public class SubmitAPPage extends AbstractPageObject {
	 ...
	 */
	public SubmitAPPage(WebDriver driver) {
		super(driver);

		// Assert title.
		Assert.assertEquals(driver.getTitle(), properties.getProperty("submitAP.title"));
	}
