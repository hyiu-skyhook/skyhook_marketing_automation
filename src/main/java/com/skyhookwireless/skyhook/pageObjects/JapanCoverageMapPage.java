 ...
 *
 */
public class JapanCoverageMapPage extends AbstractPageObject {
	 ...
	 */
	public JapanCoverageMapPage(WebDriver driver) {
		super(driver);

		// Assert title.
		Assert.assertEquals(driver.getTitle(), properties.getProperty("japanCoverageMap.title"));
	}
