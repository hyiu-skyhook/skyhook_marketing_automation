 ...
 *
 */
public class PatentsPage extends AbstractPageObject {
	 ...
	 */
	public PatentsPage(WebDriver driver) {
		super(driver);

		// Assert title.
		Assert.assertEquals(driver.getTitle(), properties.getProperty("patents.title"));
	}
