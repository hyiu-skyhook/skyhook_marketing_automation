...
import com.skyhookwireless.skyhook.enums.Platform;
import com.skyhookwireless.skyhook.pageObjects.*;

public class PrecisionLocation_OverviewPage extends AbstractPageObject {
    ...
    public PrecisionLocation_OverviewPage(WebDriver driver) {

	super(driver);

	// Assert URL.
	Assert.assertTrue(driver.getCurrentUrl().contains(properties.getProperty("resources.precision.overviewLink")));
     ...
     * 
     * @param platform
     *            The platform of the resource to be selected
     * @return Current Page
     */
