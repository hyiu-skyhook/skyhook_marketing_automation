...
public class PrecisionLocation_LinuxPage extends AbstractPageObject {
    ...
    public PrecisionLocation_LinuxPage(WebDriver driver) {

	super(driver);

	// Assert URL.
	Assert.assertTrue(driver.getCurrentUrl().contains(properties.getProperty("resources.precision.linuxLink")));
