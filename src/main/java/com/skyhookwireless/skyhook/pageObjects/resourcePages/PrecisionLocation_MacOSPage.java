...
public class PrecisionLocation_MacOSPage extends AbstractPageObject {
    ...
    public PrecisionLocation_MacOSPage(WebDriver driver) {

	super(driver);

	// Assert URL.
	Assert.assertTrue(driver.getCurrentUrl().contains(properties.getProperty("resources.precision.macOSLink")));
