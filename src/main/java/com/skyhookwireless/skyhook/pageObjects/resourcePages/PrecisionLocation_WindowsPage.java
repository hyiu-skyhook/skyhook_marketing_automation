...
public class PrecisionLocation_WindowsPage extends AbstractPageObject {
    ...
    public PrecisionLocation_WindowsPage(WebDriver driver) {

	super(driver);

	// Assert URL.
	Assert.assertTrue(driver.getCurrentUrl().contains(properties.getProperty("resources.precision.windowsLink")));
