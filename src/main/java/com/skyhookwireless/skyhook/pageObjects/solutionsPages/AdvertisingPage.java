package com.skyhookwireless.skyhook.pageObjects.solutionsPages;
 ...
 *
 */
public class AdvertisingPage extends AbstractPageObject {
	...
	public AdvertisingPage(WebDriver driver) {
		...
		// Assert title.
		Assert.assertEquals(driver.getTitle(), properties.getProperty("solutions.advertising.title"));
	}
}